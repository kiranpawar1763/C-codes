/* Write a c program to find the median of a merged sorted Array by using
 pointer and function.
-------

-> create int main() function.
-> create void mergeAndSort(int *arr1, int size1, int *arr2, int size2,
 int *mergedArray) function.
...
void mergeSort(int *arr1, int size1, int *arr2, int size2, int *mergedArray)
{
    int main()
   int str[10];
